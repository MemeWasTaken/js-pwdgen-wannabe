...
let favNumber = parseInt(prompt('Inserisci il tuo numero preferito:'));
let newNumber = favNumber + 5;
let psw = document.writeln(userName+userSurname+favColor+newNumber);